...
const PurchaseBillPendingListTable = () => {
    ...
    const purchaseBillPendingList = useSelector(state => state.bill.purchaseBillPendingList);
    ...
    const onFetchPurchaseBillPendingList = useCallback(() => dispatch(actions.fetchPurchasebillPendingList()), [dispatch,]);

    useEffect(() => {
        onFetchPurchaseBillPendingList();
    }, [])
    ...
    const emptyRows =
        rowsPerPage - Math.min(rowsPerPage, purchaseBillPendingList.length - page * rowsPerPage);
                            ...
                            <Grid item xs={12}>
                                <TableFooter>
                                    <TablePagination
                                        ...
                                        component="div"
                                        count={purchaseBillPendingList.length}
...
export default PurchaseBillPendingListTable;
